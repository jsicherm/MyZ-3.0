...
import myz.nmscode.v1_7_R3.pathfinders.PathfinderGoalNearestAttackableHorseTarget;
...
import net.minecraft.server.v1_7_R3.PathfinderGoalTame;
...
public class CustomEntityHorse extends EntityHorse implements CustomMob {
	...
	public EntityLiving getGoalTarget() {
		...
		if (getOwnerUUID() == null || getOwnerUUID().isEmpty())
			return null;
		if (!MyZ.instance.isBandit(SQLManager.fromString(getOwnerUUID(), true)))
			return null;
		return super.getGoalTarget();
	}
	...
	protected Entity findTarget() {
		if ((getOwnerUUID() == null || getOwnerUUID().isEmpty()) && ((Horse) getBukkitEntity()).getVariant() != Variant.UNDEAD_HORSE
				&& ((Horse) getBukkitEntity()).getVariant() != Variant.SKELETON_HORSE)
			return null;
